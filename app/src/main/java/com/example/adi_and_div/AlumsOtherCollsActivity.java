...
public class AlumsOtherCollsActivity extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_alums_other_colls);
        ...
        Button selectCollegeButton = findViewById(R.id.button20);
